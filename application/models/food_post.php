...
class foodSupplierPost{
    ...
    public static function foodPost($resName,$address,$location,$description,$image_name,$type,$otDeadline,$Lifespan,$Aamount,$connection){
        //$hh=$resName;
        //echo $hh;
        //echo $individual;
        //echo "dssssss";
        ...
        VALUES(null,1,'{$resName}','{$description}','{$address}','{$location}','{$type}',1,'{$otDeadline}','{$Lifespan}','{$Aamount}','{$image_name}')";
