...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <h2>Bodima </h2>
            <h4>Mathara Bath Kade </h4>
            <h3>Your order is accepted </h3>
        </div>
        </div>
        <div class="content">
           <div class="para"> <p>Thanks for your order. We prepare your order and  we will delivery you mentioned address. First follwing the instruction for payment for order.   </p></div>
            <div class="price-details">
                <div class="total">
                    <h3>Payment method</h3>
                </div>
                <div class="details">
                    <h5>Total payment <span class="left-item">Rs <?php  ?></span></h5>
